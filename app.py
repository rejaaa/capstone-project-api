    ...
    if request.method == 'POST':
        ...
        if len(doc.ents) > 0:
            for ent in doc.ents:
                ...
                LAW_named_entity = df[df['category'] == 'LAW']['value']
                NORP_named_entity = df[df['category'] == 'NORP']['value']
                CARDINAL_named_entity = df[df['category'] == 'CARDINAL']['value']
                FAC_named_entity = df[df['category'] == 'FAC']['value']
                TIME_named_entity = df[df['category'] == 'TIME']['value']
                WORKOFART_named_entity = df[df['category'] == 'WORK_OF_ART']['value']
                PRODUCT_named_entity = df[df['category'] == 'PRODUCT']['value']
                LOC_named_entity = df[df['category'] == 'LOC']['value']
                QUANTITY_named_entity = df[df['category'] == 'QUANTITY']['value']
                EVENT_named_entity = df[df['category'] == 'EVENT']['value']
                LANGUAGE_named_entity = df[df['category'] == 'LANGUAGE']['value']
                # END OF TASK 
            ...
            if choice == 'organization':
                ...
                num_of_results = len(results)
            elif choice == 'workofart':
                results = WORKOFART_named_entity
                num_of_results = len(results)
            elif choice == 'product':
